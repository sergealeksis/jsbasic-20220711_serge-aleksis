...
export default class Cart {
  ...
  renderModal() {
    ...
    this.cartItems.map(e => this.modalBody.append(this.renderProduct(e.product, e.count)));
    ...
    this.modalBody.querySelectorAll('.cart-counter__button').forEach(e => e.onclick = (event) => {
      let prdct = event.target.closest('[data-product-id]');
      this.updateProductCount(
        prdct.dataset.productId,
